...
class _ChatDoctorPageState extends State<ChatDoctorPage> {
  ...
  final Uri url = Uri.parse('http://${BASEURL}:3001/api/v1/workspace/pet_doctor/stream-chat');
  ...
  void initState() {
    super.initState();
    _messages.add(Message(content: '你好呀，我是你的专属宠物医生，我有很丰富的宠物专业知识，您可以尽情提问噢^_^', role: 'assistant'));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('宠物医生')),
      body: Column(
        children: [
          Expanded(
